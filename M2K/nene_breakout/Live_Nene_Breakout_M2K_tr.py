                ...
                if self.connected:
                    ...
                    if self.position != 0:
                        ...
                        if self.position < 0:
                            ...
                            # By stop ==========
                            ## Stop 1
                            if self.check_pendings(ord_sell_sl_1) and and not exit_1 self.position < 0:   # Check if stop 1 is filled
...
if __name__ == '__main__':
    ...
    live_nene = LiveNene(symbol=symbol, bot_name='Nene Breakout', temp='1 min', port=port, client=client, real=False)
    live_nene.run_strategy(contracts=4, stop=3, target_1=4, target_2=6, num_bars=12, trailing=0.6, num_days=3)