...
if __name__ == '__main__':
    ...
    live_hermes.run_strategy(contracts=2, pattern=pattern, stop=3, target_1=3, target_2=5, num_bars=10, trailing=0.9, lr_period=10, 
                            lr_previous_1=3, lr_previous_2=5, lr_distance_1=0, lr_distance_2=5, num_days=4)